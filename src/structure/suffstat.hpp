...
struct ss_factory   {
    ...
    class suffstat_array_proxy0 final : public Proxy<SS&,int> {
        ...
        suffstat_array_proxy0(size_t size, const SS& from, Lambda lambda) : _ss(size,from), _lambda(lambda) {}
    ...
    class suffstat_array_proxy1 final : public Proxy<SS&,int>    {
        ...
        suffstat_array_proxy1(size_t size, const SS& from, Lambda lambda, int n) : _ss(size,from), _lambda(lambda), _n(n) {}
